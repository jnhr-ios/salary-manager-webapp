...
Calculated and displayed the avarage salary by using the previous data
Selected a random employee to be the random drawing winner

The URL of the GitHub repository:
https://github.com/jnhr-ios/salary-manager-webapp

The Webpage:
https://jnhr-ios.github.io/salary-manager-webapp/
